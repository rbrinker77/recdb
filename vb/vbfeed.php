...
<?php
  ...
  if ( $instaname <> "" ) {
    ...
    echo "<div>";
    echo "<a href='https://www.instagram.com/".$instaname."/'><img  src='".$instas['entry_data']['ProfilePage']['0']['graphql']['user']['profile_pic_url_hd']."' title='".$instas['entry_data']['ProfilePage']['0']['graphql']['user']['biography']."' alt='".$instaname." Profile Pic' /></a>
      </div>
      <div>";
